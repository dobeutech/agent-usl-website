...
const targetPath = path.resolve(__dirname, '..', 'src', 'pages', 'AdminLogin.tsx');
fs.writeFileSync(targetPath, loginContent);
console.log('Updated AdminLogin.tsx at:', targetPath);
